...
const docTemplate = `{
    ...
    "paths": {
        "/api/profile": {
            "get": {
                "description": "Retrieve the authenticated user's banking profile using JWT Bearer token",
                "produces": [
                    "application/json"
                ],
                "tags": [
        ...
        "/api/branches": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Search query — filters by branch name",
                        "name": "q",
                        "in": "query"
                    }
                ],
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/models.InterestRate"
                            }
                        }
                    },
                    "500": {
